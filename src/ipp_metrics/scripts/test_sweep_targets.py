...
class ParameterSweepManager(object):
    def __init__(self, folder_path, targets_list):
    ...
    def run_parameter_sweep(self):
        ...
        for targets_param in self.targets_list:
            ...
            folder_name = "targets_" + str(targets_param)
            ...
            self.launch_args = ['metrics', 'sim_mc_runs.launch','rviz:=false', 'include_cpu_mem_monitor:=true', 
                ...
                'search:=true', 'track:=false', 'mc_config:=mc_testing_search1_random.yaml', 
            ...
            rospy.logwarn("Parameters set to: target_num: {}".format(targets_param))
...
if __name__ == "__main__":
    ...
    manager = ParameterSweepManager(folder_path, targets_list)
